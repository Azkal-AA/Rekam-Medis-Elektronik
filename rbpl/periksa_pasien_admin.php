...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($konek, "INSERT INTO pemeriksaan VALUES ('', '$no_antrian', '$bb','$tb','$suhu','$td','$dn','$nafas','$subject','$object','$assesment','$plan')");

    if ($query) {
        header("Location: rawat_pasien_admin.php?no_rm=$no_antrian");
    } else {
            ...
            <form action="" method="POST">
                <div class="mt-3">
                    <table>
                        ...
                        <tr>
                            <td><input type="text" name="bb" class="form-control rounded"></td>
                            <td><input type="text" name="tb" class="form-control rounded"></td>
                            <td><input type="text" name="suhu" class="form-control rounded"></td>
                            <td><input type="text" name="td" class="form-control rounded"></td>
                            <td><input type="text" name="dn" class="form-control rounded"></td>
                            <td><input type="text" name="nafas" class="form-control rounded"></td>
                        </tr>
                    </table>
                </div>
                <hr>
                <div class=" mt-3">
                    <center>
                        <table>
                            <tr>
                                <th>Subject (S)</th>
                                <td><textarea name="subject" id="subject" class="form-control"></textarea></td>
                                <th>Object (O)</th>
                                <td><textarea name="object" id="object" class="form-control"></textarea></td>
                                <th>Assesment (A)</th>
                                <td><textarea name="assesment" id="assesment" class="form-control"></textarea></td>
                                <th>Plan (P)</th>
                                <td><textarea name="plan" id="plan" class="form-control"></textarea></td>
                            </tr>
                        </table>
                    </center>
                </div>
