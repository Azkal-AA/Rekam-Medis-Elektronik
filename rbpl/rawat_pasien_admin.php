...
if (isset($_POST['submit'])) {
    ...
    $stat = mysqli_query($konek, "UPDATE antrian SET status = '$status' WHERE no_rm = '$no_antrian'");
    $qry = mysqli_query($konek, "INSERT INTO riwayat VALUES ('', '$no_antrian', '$tgl')");
    $query = mysqli_query($konek, "INSERT INTO perawatan VALUES ('', '$no_antrian', '$perawatan','$obat','$keterangan')");

    if ($stat && $query && $qry && $_SESSION['job'] == "admin") {
        header("location: daftar_antrian_dokter_admin.php");
    } else if ($stat && $query && $qry && $_SESSION['job'] == "dokter") {
                ...
                <div class="mt-1">
                    <center>
                        <table>
                            ...
                            <tr>
                                <td><textarea name="perawatan" id="perawatan" class="form-control-lg"></textarea></td>
                                <td></td>
                                <td><select name="obat" id="obat" class="form-select-lg">
                                        <?php
                                        $qry = $konek->query("select * from obat ");
                                ...
                                <td></td>
                                <td><textarea name="keterangan" id="keterangan" class="form-control-lg"></textarea></td>
                            </tr>
                        </table>
                    </center>
                </div>
